...
import { Row, Col, Card, div, CardBody, UncontrolledCollapse } from 'reactstrap';
                    ...
                    <Col sm={12}>
                        <Card className={"iq-card"}>
                            <div className={"iq-card-header d-flex justify-content-between"}>
                                <div className={"iq-header-title"}><h4 className="card-title">Display headings</h4></div>
...
<h6 className="mb-0">h6. Bootstrap heading</h6>
                        ...
                        <Card className="iq-card">
                            <div className="iq-card-header d-flex justify-content-between">
                                <div className={"iq-header-title"}><h4 className="card-title">Inline text elements</h4></div>
...
<p><em>This line rendered as italicized text.</em></p>     `}
                        ...
                        <Card className="iq-card">
                            <div className="iq-card-header d-flex justify-content-between">
                                <div className={"iq-header-title"}><h4 className="card-title">Lists Inline</h4></div>
...
<li className="list-inline-item">Nulla volutpat</li>
                    ...
                    <Col sm={12} lg={6} >
                        <Card className="iq-card">
                            <div className="iq-card-header d-flex justify-content-between">
                                <div className={"iq-header-title"}> <h4 className="card-title">Headings</h4></div>
...
<p className="h6 mb-0">h6. Bootstrap heading</p>
                        ...
                        <Card className="iq-card">
                            <div className="iq-card-header d-flex justify-content-between">
                                <div className={"iq-header-title"}><h4 className="card-title">Lists Unstyled</h4></div>
...
<footer className="blockquote-footer">Someone famous in <cite title="Source Title">Source Title</cite></footer>
                    ...
                    <Col sm={12}>
                        <Card className={"iq-card"}>
                            <div className={"iq-card-header d-flex justify-content-between"}>
                                <div className={"iq-header-title"}><h4 className="card-title">Description list alignment</h4></div>
